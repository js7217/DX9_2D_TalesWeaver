...
HRESULT CSoracap::LateInit()
{
	m_tData.strName = L"소라캡";
...
void CSoracap::MoveFrame(float fSpeed)
{
	switch (m_eCurState)
	{
	case CMonster::STAND:
...
HRESULT CSoracap::Create(float fX, float fY, UNIT_DATA tData)
{
	CSoracap* pInstance = new CSoracap;
